...
//            configList.add(new PlayerConfig("/home/kitchen/ambientlight/", "sound_beim_anzuenden.wav", PLAY));
            ...
            configList.add(new PlayerConfig("MOTION_SENSOR_1", "/birds/1.wav", CUSTOM));
            configList.add(new PlayerConfig("MOTION_SENSOR_2", "/birds/2.wav", CUSTOM));
            configList.add(new PlayerConfig("MOTION_SENSOR_3", "/birds/3.wav", CUSTOM));
            configList.add(new PlayerConfig("MOTION_SENSOR_4", "/birds/4.wav", CUSTOM));
            configList.add(new PlayerConfig("MOTION_SENSOR_5", "/birds/5.wav", CUSTOM));
            configList.add(new PlayerConfig("MOTION_SENSOR_6", "/birds/6.wav", CUSTOM));
            configList.add(new PlayerConfig("MOTION_SENSOR_7", "/birds/7.wav", CUSTOM));
            configList.add(new PlayerConfig("MOTION_SENSOR_8", "/birds/8.wav", CUSTOM));
            configList.add(new PlayerConfig("MOTION_SENSOR_9", "/birds/9.wav", CUSTOM));
            configList.add(new PlayerConfig("MOTION_SENSOR_10", "/birds/10.wav", CUSTOM));
            configList.add(new PlayerConfig("MOTION_SENSOR_11", "/birds/11.wav", CUSTOM));
